...
class MockRepositoryBukuTest {
    ...
    void testCariByJudulCaseInsensitive() {
        ...
        assertEquals(2, hasil2.size(), "Case insensitive");
        assertEquals(2, hasil3.size(), "Case insensitive");
    ...
    void testIntegrationFlowPeminjam() {
        ...
        boolean updateKembali = mockRepository.updateJumlahTersedia("1234567890", 5);
        assertTrue(updateKembali);
